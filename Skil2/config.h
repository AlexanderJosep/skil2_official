...
namespace config {
    ...
    const int DISPLAY_COMPUTER_INSTRUCTIONS_LENGTH = 5;
    ...
    const string DISPLAY_COMPUTER_INSTRUCTIONS[DISPLAY_COMPUTER_INSTRUCTIONS_LENGTH] = {"Use 'b' to organize by if it was built or not",
                                    "Use 'n' to organize by names in alphabetical order.", "Use 'y' to organize by year it was built.",
                                    "Use 't' to organize by type.", "Use 'o' to have no organization."};
}
