...
namespace config {
    ...
    const char COMMANDS[19] = {'d', 's', 'a', 'i', 'q', 'c', 'e', 'r', 'g', // Instructions
                               'o', 'n', 'g', 'b', 'd', // Organization persons
                               'o', 'n', 'y', 't', 'b'}; // Organization computers
    const string INSTRUCTIONS[9] = {"Use 'a' to add computer or person to the list.", "Use 'c' to clear the console.",
    ...
    const string DISPLAY_PERSON_INSTRUCTIONS[5] = {"Use 'b' to organize by birth year.", "Use 'd' to organize by death year.",
                                                 "Use 'g' to organize by gender.", "Use 'n' to organize by names in alphabetical order.",
                                                 "Use 'o' to have no organization."};
    const string DISPLAY_COMPUTER_INSTRUCTIONS[5] = {"Use 'b' to organize by if it was built or not",  "Use 'n' to organize by names in alphabetical order.",
